    ...
    <div id="company2" class="clearfix">
        <table id="cuadro" width="150">
            ...
            <tr>
                ...
                <td style="max-width:20px;overflow-wrap: break-word;">{{ ($service_order->payment_condition !== null) ? $service_order->payment_condition:'No tiene condición' }}</td>
            </tr>
            <tr>
                <td>MONEDA:</td>
...
<main>
    ...
    <table id="table">
        ...
        <tr>
            ...
            <td class="qty" style="text-align: center"> {{ $service_order->currency_order }} {{ number_format($detail->price, 2) }}</td>
            <td class="qty" style="text-align: center">{{ $detail->quantity }}</td>
            <td class="qty" style="text-align: center">{{ $service_order->currency_order }} {{ number_format($detail->price*$detail->quantity, 2) }}</td>
        </tr>
        @endforeach
        </tbody>
    </table>
