...
<table id="table">
    ...
    <tr>
        ...
        <th width="300px" style="word-wrap: break-word; background-color: #1c3c80; font-size: 13px; color: white">DESCRIPCIÓN DE TAREA</th>
    ...
    @for( $i = 0; $i < count( $tasks ); $i++ )
        @if ( $i == 0 )
            <tr>
                ...
                <td width="300px" style="word-wrap: break-word; border-left:1px solid #1c3c80; border-right:1px solid #1c3c80">{{ $tasks[$i]['task'] }}</td>
                ...
                <td width="90px" style="word-wrap: break-word; border-left:1px solid #1c3c80; border-right:1px solid #1c3c80; border-top:1px solid #1c3c80; border-bottom:1px solid #1c3c80">{{ $tasks[$i]['worker'] }}</td>
                    ...
                    @if ( $tasks[$i]['task'] == $tasks[$i-1]['task'] )
                        @if ( $i == count($tasks)-1 )
                            <tr>
                                ...
                                <td width="300px" style="word-wrap: break-word; border-left:1px solid #1c3c80; border-right:1px solid #1c3c80; border-bottom:1px solid #1c3c80"></td>
                                ...
                                <td width="90px" style="word-wrap: break-word; border-left:1px solid #1c3c80; border-right:1px solid #1c3c80; border-bottom:1px solid #1c3c80; border-top:1px solid #1c3c80">{{ $tasks[$i]['worker'] }}</td>
                        ...
                        @else
                            <tr>
                                ...
                                <td width="300px" style="word-wrap: break-word; border-left:1px solid #1c3c80; border-right:1px solid #1c3c80"></td>
                    ...
                    @else
                        @if ( $i == count($tasks)-1 )
                            <tr>
                                ...
                                <td width="160px" style="word-wrap: break-word; border-left:1px solid #1c3c80; border-right:1px solid #1c3c80; border-bottom:1px solid #1c3c80"></td>
                                <td width="120px" style="word-wrap: break-word; border-left:1px solid #1c3c80; border-right:1px solid #1c3c80; border-bottom:1px solid #1c3c80"></td>
                                <td width="300px" style="word-wrap: break-word; border-left:1px solid #1c3c80; border-right:1px solid #1c3c80; border-top:1px solid #1c3c80; border-bottom:1px solid #1c3c80">{{ $tasks[$i]['task'] }}</td>
                        ...
                        @else
                            <tr>
                                ...
                                <td width="160px" style="word-wrap: break-word; border-left:1px solid #1c3c80; border-right:1px solid #1c3c80"></td>
                                <td width="120px" style="word-wrap: break-word; border-left:1px solid #1c3c80; border-right:1px solid #1c3c80"></td>
                                <td width="300px" style="word-wrap: break-word; border-left:1px solid #1c3c80; border-right:1px solid #1c3c80; border-top:1px solid #1c3c80">{{ $tasks[$i]['task'] }}</td>
                ...
                @else
                    @if ( $i == count($tasks)-1 )
                        <tr>
                            ...
                            <td width="300px" style="word-wrap: break-word; border-left:1px solid #1c3c80; border-right:1px solid #1c3c80; border-bottom:1px solid #1c3c80">{{ $tasks[$i]['task'] }}</td>
