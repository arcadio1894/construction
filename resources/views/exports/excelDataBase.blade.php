...
<table id="table">
    <thead>
        <tr>
            ...
            <th width="150px" style="background-color: #7A8DC5; font-size: 14px">Medida</th>
            <th width="150px" style="background-color: #7A8DC5; font-size: 14px">Unidad Medida</th>
            <th width="150px" style="background-color: #7A8DC5; font-size: 14px">Stock Max.</th>
            <th width="150px" style="background-color: #7A8DC5; font-size: 14px">Stock Min.</th>
