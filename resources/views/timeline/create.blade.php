...
@section('page-title')
    ...
    <button type="button" id="lostActivity" class="btn btn-danger btn-sm float-right" > <i class="fas fa-list-alt"></i> Actividades pendientes </button>
...
--}}
                                                                ...
                                                                <div class="accordion-group">
                                                                    <div class="accordion-heading ponto">
                                                                        ...
                                                                        <div class="dropdown dropleft edit">
                                                                            ...
                                                                            <div class="dropdown-menu">
                                                                                <a class="dropdown-item" href="#" data-savetask="{{ $task->id }}" ><i class="far fa-edit text-orange"></i> Guardar Tarea</a>
                                                                                <div class="dropdown-divider"></div>
                                                                        ...
                                                                        <div class="accordion-inner">
                                                                            <div class="row">
                                                                                <div class="col-sm-4">
                                                                                    ...
                                                                                    <textarea name="" data-activity cols="30" class="form-control form-control-sm">{{$task->activity}}</textarea>
                                                                                ...
                                                                                <div class="col-sm-4">
                                                                                    ...
                                                                                    <div class="input-group input-group-sm mb-3">
                                                                                        <input type="number" min="0" step="0.1" readonly value="{{ $task->progress }}" data-progress class="form-control form-control-sm">
    ...
    <template id="template-lostActivity">
        <tr>
            ...
            <td data-progress></td>
            <td>
                <button type="button" data-tasklostid class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Agregar</button>
            </td>
        </tr>
    </template>
@endsection
