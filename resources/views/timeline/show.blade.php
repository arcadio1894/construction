                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="number" min="0" step="0.1" data-progress class="form-control " value="{{ $activity->progress }}" readonly>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-3">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-7">
                                                                    <input type="number" readonly min="0" step="0.1" data-hoursreal name="hours_real" value="{{ $collaborator->hours_real }}" class="form-control form-control-sm ">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        {{--<div class="col-sm-1">
