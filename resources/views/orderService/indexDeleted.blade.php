...
@section('activeListOrderServiceDeleted')
    active
@endsection

@section('title')
    Orden de servicios anuladas
@endsection
...
@section('page-title')
    <h5 class="card-title">Listado de Ordenes de Servicios anuladas</h5>
...
@section('scripts')
    ...
    <script src="{{ asset('js/orderService/indexDeleted.js') }}"></script>
@endsection