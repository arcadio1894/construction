...
@section('page-breadcrumb')
    <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item">
            <a href="{{ route('unitmeasure.index') }}"><i class="fa fa-key"></i> Unidades de medidas</a>
        </li>
    ...
    <form id="formEdit" class="form-horizontal" data-url="{{ route('unitmeasure.update') }}" enctype="multipart/form-data">
        ...
        <div class="form-group row">
            <div class="col-md-6">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="name" placeholder="Ejm: Unidad de medida" value="{{$unitMeasure->name}}">
                </div>
            </div>
            ...
            <div class="col-md-6">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="description" placeholder="Ejm: Descripción" value="{{$unitMeasure->description}}">
                </div>
            </div>
        </div>
