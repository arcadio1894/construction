                                ...
                                <table class="table table-striped">
                                    ...
                                    <template id="template-summary">
                                        <tr>
                                            ...
                                            <td data-acEquipment>
                                                <button type="button" class="btn btn-sm btn-outline-primary" data-acPercentage="" data-acEquipment="" data-utility="" data-rent="" data-letter=""><i class="fas fa-percentage"></i></button>
                                                <button type="button" class="btn btn-sm btn-outline-warning" data-acEdit="" data-acEquipment="" ><i class="fas fa-percentage"></i></button>
                                                <button type="button" class="btn btn-sm btn-outline-danger" data-acDelete="" data-acEquipment="" ><i class="fas fa-trash"></i></button>
                                            </td>
                                        </tr>
                                    </template>
                                </table>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" placeholder="Nombre del equipo..." autocomplete="off">
