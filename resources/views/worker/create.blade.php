                                ...
                                <div class="form-group row">
                                    <div class="col-md-6">
                                        <div class="icheck-primary d-inline">
                                            <input type="radio" id="gender1" name="gender" value="f" checked>
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="admission_date" class="form-control" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="termination_date" class="form-control" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <div class="col-sm-6">
                                ...
                                <textarea name="" cols="30" class="form-control" style="word-break: break-all;" placeholder="Ingrese dirección ...."></textarea>
                            </div>
                            <div class="col-sm-6">
                                <label for="email">Email </label>
                                <textarea name="" cols="30" class="form-control" style="word-break: break-all;" placeholder="Ingrese email ...."></textarea>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="phone" class="form-control" data-inputmask='"mask": "(99) 999-999-999"' data-mask>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="birthplace" class="form-control" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask>
                                </div>
                            </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                ...
                                <input type="number" id="num_children" name="num_children" class="form-control" placeholder="0.00" min="0" value="0" step="0.01">
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    <input type="number" id="essalud" name="essalud" class="form-control" placeholder="0.00" min="0" value="{{ $value_essalud }}" step="0.01" >
                            ...
                            <div class="col-md-3">
                                ...
                                <select id="pension_system" name="pension_system" class="form-control select2" style="width: 100%;">
                                    <option></option>
                                    @foreach( $pension_systems as $pension_system )
                                        <option value="{{ $pension_system->id }}">{{ $pension_system->description.'-'.$pension_system->percentage.'%' }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-3">
