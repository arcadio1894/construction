...
@section('page-title')
    <h5 class="card-title">Listado de razones de suspensión</h5>
    <a href="{{ route('reasonSuspension.create') }}" class="btn btn-outline-success btn-sm float-right" > <i class="fa fa-plus font-20"></i> Nueva razón de suspensión </a>
...
@section('scripts')
    <script src="{{ asset('js/reasonSuspension/index.js') }}"></script>
@endsection