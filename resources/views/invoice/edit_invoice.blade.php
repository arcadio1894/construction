...
@section('content')
    <form id="formEdit" class="form-horizontal" data-url="{{ route('invoice.update') }}" enctype="multipart/form-data">
        @csrf
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="type_order" name="type_order" class="form-control select2" style="width: 100%;">
                                        <option></option>
                                        <option value="purchase" {{ ($entry->type_order === 'purchase') ? 'selected':'' }}>Por compra</option>
                                        <option value="service" {{ ($entry->type_order === 'service') ? 'selected':'' }}>Por servicio</option>
                                    </select>
                                </div>
                                <div class="form-group">
