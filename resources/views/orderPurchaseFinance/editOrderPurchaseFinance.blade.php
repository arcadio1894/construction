...
@section('page-header')
    <h1 class="page-title">Editar Orden de Compra Finanzas</h1>
@endsection
...
@section('page-breadcrumb')
    <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item">
            <a href="{{route('order.purchase.finance.index')}}"><i class="fa fa-key"></i> Ordenes de Compra Finanzas</a>
        </li>
...
@section('content')
    <form id="formCreate" class="form-horizontal" data-url="{{ route('order.purchase.finance.update') }}" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="service_order">Orden de Compra</label>
                                    <input type="text" id="service_order" name="service_order" class="form-control" value="{{ $order->code }}" readonly>
                                </div>
                                ...
                                <div class="form-group " id="sandbox-container">
                                    ...
                                    <div class="input-daterange" id="datepicker">
                                        <input type="text" class="form-control date-range-filter" id="date_delivery" name="date_delivery" value="{{ \Carbon\Carbon::parse($order->date_delivery)->format('d/m/Y')}}">
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    {{--<input type="text" id="service_condition" name="service_condition" class="form-control" value="{{ $order->payment_condition }}">--}}
                ...
                <div class="card card-warning">
                    ...
                    <div class="card-body " id="element_loader">
                        <div class="row">
                            <div class="col-md-5">
                                <div class="form-group">
                                    <label for="service">Ingresar concepto <span class="right badge badge-danger">(*)</span></label>
                        ...
                        <div id="body-services">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-sm" data-service value="{{ $detail->material }}" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <div class="form-group">
                                            <input type="text" onkeyup="mayus(this);" class="form-control form-control-sm" data-unit value="{{ $detail->unit }}" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-1">
                                    <div class="form-group">
                                        <input type="number" class="form-control form-control-sm" oninput="calculateTotal(this);" placeholder="0.00" min="0" value="{{ $detail->quantity }}" data-quantity="{{$detail->id}}" step="0.01" >
                                    </div>
                                </div>
                                ...
                                <div class="col-md-1">
                                    <div class="form-group">
                                        <input type="number" class="form-control form-control-sm" oninput="calculateTotal3(this);" placeholder="0.00" min="0" data-price2="{{$detail->id}}" value="{{ round($detail->price/1.18,2) }}" step="0.01" pattern="^\d+(?:\.\d{1,2})?$">
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <input type="number" class="form-control form-control-sm" placeholder="0.00" min="0" data-total="{{$detail->id}}" step="0.01" value="{{ number_format($detail->total_detail,2, '.', '') }}" pattern="^\d+(?:\.\d{1,2})?$" onblur="
                                            this.style.borderColor=/^\d+(?:\.\d{1,2})?$/.test(this.value)?'':'red' " >
                                    </div>
                                </div>
                                <div class="col-md-1">
                                    <div class="btn-group">
                                        ...
                                        <button type="button" data-delete="{{ $detail->id }}" class="btn btn-outline-danger btn-sm"><i class="fas fa-trash"></i> </button>
                                    </div>
    ...
    <template id="service-selected">
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    <div class="form-group">
                        <input type="text" class="form-control form-control-sm" data-service readonly>
                    </div>
                </div>
            </div>
            <div class="col-md-2">
                <div class="form-group">
                    <div class="form-group">
                        <input type="text" class="form-control form-control-sm" data-unit readonly>
                    </div>
                </div>
            </div>
...
*/
    ...
    <script src="{{ asset('js/orderPurchaseFinance/editOrderFinance.js') }}"></script>
@endsection
