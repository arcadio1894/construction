...
@section('content')
    <form id="formCreate" class="form-horizontal" data-url="{{ route('order.purchase.finance.store') }}" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-md-12">
...
@section('scripts')
    ...
    <script src="{{ asset('js/orderPurchaseFinance/createOrderFinance.js') }}"></script>
@endsection
