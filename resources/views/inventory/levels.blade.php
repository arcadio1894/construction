...
@section('page-breadcrumb')
    <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item"><i class="fa fa-lock"></i> Niveles</li>
    </ol>
@endsection
...
@section('content')
    ...
    <div id="modalCreate" class="modal fade" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="formCreate" class="form-horizontal" data-url="{{ route('level.store') }}" enctype="multipart/form-data">
                    @csrf
    ...
    <div id="modalEdit" class="modal fade" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="formEdit" class="form-horizontal" data-url="{{ route('level.update') }}" >
                    @csrf
    ...
    <div id="modalDelete" class="modal fade" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">¿Desea eliminar el nivel?</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                </div>
                <form id="formDelete" data-url="{{ route('level.destroy') }}">
                    @csrf
                    <div class="modal-body">
