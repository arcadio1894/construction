...
@section('content')
    ...
    <template id="template-attended">
        <button data-toggle="tooltip" data-placement="top" title="Materiales en la cotización" data-materials="'+item.execution_order+'" class="btn btn-outline-info btn-sm"><i class="fas fa-hammer"></i> </button>
        ...
        <button data-toggle="tooltip" data-placement="top" title="Editar orden de ejecución" data-edit="' + item.id + '" data-execution_order="' + item.execution_order + '" class="btn btn-outline-secondary btn-sm"><i class="fas fa-edit"></i> </button>
    </template>
    ...
    <template id="template-created">
        ...
        <button data-toggle="tooltip" data-placement="top" title="Atender" data-attend="' + item.id + '" class="btn btn-outline-success btn-sm"><i class="fa fa-check-square"></i> </button>
        <button data-toggle="tooltip" data-placement="top" title="Editar orden de ejecución" data-edit="' + item.id + '" data-execution_order="' + item.execution_order + '" class="btn btn-outline-secondary btn-sm"><i class="fas fa-edit"></i> </button>
    </template>
...
@section('scripts')
    ...
    <script src="{{ asset('js/orderPurchase/generalV2.js') }}"></script>
