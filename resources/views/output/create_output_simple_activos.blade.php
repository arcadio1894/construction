            ...
            <div class="col-md-12">
                <div class="card card-warning">
                    ...
                    <div class="card-body" id="element_loader">
                        ...
                        <div class="row">
                            <div class="col-sm-8">
                                <label for="material">Buscar material <span class="right badge badge-danger">(*)</span></label>
                            ...
                            <div class="col-md-2" style="display: none;" id="div-btn-type">
                                <label for="btn-type"> Activo? </label><br>
                                <input id="btn-type" type="checkbox" name="type_active" data-bootstrap-switch data-off-color="danger" data-on-text="SI" data-off-text="NO" data-on-color="success">
                            </div>
                            <div class="col-md-2" >
                                <label for="btn-add"> &nbsp; </label><br>
                                <button type="button" id="btn-add" class="btn btn-outline-primary">Seleccionar  <i class="fas fa-arrow-circle-right"></i></button>
                            </div>
                        </div>
                        <hr>
...
@section('scripts')
    ...
    <script src="{{ asset('js/output/output_simple_activo.js') }}"></script>
@endsection
