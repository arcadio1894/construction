...
@section('page-header')
    <h1 class="page-title">Listado de Cotizaciones Elevadas</h1>
@endsection

@section('page-title')
    <h5 class="card-title">Listado de cotizaciones Elevadas</h5>
    @can('create_quote')
...
@section('scripts')
    ...
    <script src="{{ asset('js/quote/raiseV2.js') }}"></script>
