...
@section('page-title')
    <h5 class="card-title">Listado de cotizaciones finalizadas </h5>
    @can('create_quote')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                <strong>Importante!</strong> Aquí se listarán las cotizaciones finalizadas previamente.
...
@section('scripts')
    ...
    <script src="{{ asset('js/quote/close.js') }}"></script>
@endsection