...
@section('page-title')
    <h5 class="card-title">Reemplazar materiales en cotización</h5>
@endsection
...
@section('page-breadcrumb')
    <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item"><i class="fa fa-plus-circle"></i> Reemplazar materiales</li>
    </ol>
@endsection
...
@section('content')
    ...
    <form id="formEdit" class="form-horizontal" data-url="" enctype="multipart/form-data">
        ...
        <div class="row" id="element_loader">
            ...
            <div class="col-md-12">
                <div class="card {{ ($equipment->finished) ? 'card-danger': 'card-success' }}  collapsed-card">
                    <div class="card-header">
                        <h3 class="card-title">EQUIPO: {{$equipment->description}}</h3>

                        <div class="card-tools">
                            @if ( $equipment->finished )
                                <a class="btn btn-primary btn-sm" data-enable data-quote="{{ $quote->id }}" data-equipment="{{ $equipment->id }}" data-toggle="tooltip" title="Finalizar equipos">
                                    <i class="fas fa-check-square"></i> Habilitar equipo
                                </a>
                            @else
                                <a class="btn btn-primary btn-sm" data-finish data-quote="{{ $quote->id }}" data-equipment="{{ $equipment->id }}" data-toggle="tooltip" title="Finalizar equipos">
                                    <i class="fas fa-check-square"></i> Finalizar equipo
                                </a>
                            @endif
                                    ...
                                    @can('showPrices_quote')
                                        @foreach( $equipment->workforces as $workforce )
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <input type="text" onkeyup="mayus(this);" class="form-control form-control-sm" value="{{ $workforce->description }}" data-manoDescription readonly>
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                        ...
                                        <div data-bodyTorno>
                                            ...
                                            @foreach( $equipment->turnstiles as $turnstile )
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <input type="text" onkeyup="mayus(this);" class="form-control form-control-sm" value="{{ $turnstile->description }}" data-tornoDescription readonly>
                                                        </div>
                                                    </div>
                                    ...
                                    @can('showPrices_quote')
                                        @foreach( $equipment->workdays as $workday )
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <input type="text" value="{{ $workday->description }}" onkeyup="mayus(this);" class="form-control form-control-sm" data-description readonly>
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-group">
                            ...
                            <div class="card-body">
                                ...
                                <div data-bodyDia>
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <input type="number" class="form-control form-control-sm" placeholder="0.00" value="51.00" oninput="calculateTotalPrice(this);" min="0" data-precio step="0.01" pattern="^\d+(?:\.\d{1,2})?$" onblur="
                                                this.style.borderColor=/^\d+(?:\.\d{1,2})?$/.test(this.value)?'':'red'
                                                " @cannot('showPrices_quote') readonly @endcannot>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <input type="number" class="form-control form-control-sm" placeholder="0.00" oninput="calculateTotalPrice(this);" value="51.00" min="0" data-precio step="0.01" pattern="^\d+(?:\.\d{1,2})?$" onblur="
                                                this.style.borderColor=/^\d+(?:\.\d{1,2})?$/.test(this.value)?'':'red'
                                                " @cannot('showPrices_quote') readonly @endcannot>
                                            </div>
                                        </div>
...
@section('scripts')
    ...
    <script src="{{ asset('js/quote/finish_equipment.js') }}"></script>
@endsection
