...
@section('page-title')
    <h5 class="card-title">Listado de subcategorías</h5>
    <a href="{{ route('subcategory.create') }}" class="btn btn-outline-success btn-sm float-right" > <i class="fa fa-plus font-20"></i> Nueva subcategoría </a>
@endsection
...
@section('page-breadcrumb')
    <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item">
            <a href="{{ route('subcategory.index') }}"><i class="fa fa-key"></i> Subcategorías</a>
        </li>
