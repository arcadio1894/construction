...
<main>
    ...
    <div class="slider-area ">
        <div class="slider-active">
            <div class="single-slider  hero-overly slider-height d-flex align-items-center" data-background="{{ asset('landing/img/hero/h1_hero.jpg') }}">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-11">
    ...
    <section class="support-company-area fix pt-10">
        <div class="support-wrapper align-items-end">
            ...
            <div class="right-content">
                <!-- img -->
                <div class="right-img">
                    <img src="{{ asset('landing/img/gallery/safe_in.png') }}" alt="">
                </div>
                            ...
                            <div class="project-caption">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="single-project mb-30">
                                            <div class="project-img">
                                                <img src="{{ asset('landing/img/gallery/project2.png') }}" alt="">
                                            </div>
                                            <div class="project-cap">
                                                <a href="#" class="plus-btn"><i class="ti-plus"></i></a>
                                                <h4><a href="#">Floride Chemicals</a></h4>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="single-project mb-30">
                                            <div class="project-img">
                                                <img src="{{ asset('landing/img/gallery/project3.png') }}" alt="">
                                            </div>
                                            <div class="project-cap">
                                                <a href="#" class="plus-btn"><i class="ti-plus"></i></a>
                                                <h4><a href="#">Floride Chemicals</a></h4>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="single-project mb-30">
                                            <div class="project-img">
                                                <img src="{{ asset('landing/img/gallery/project4.png') }}" alt="">
                                            </div>
                                            <div class="project-cap">
                                                <a href="#" class="plus-btn"><i class="ti-plus"></i></a>
                                                <h4><a href="#">Floride Chemicals</a></h4>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="single-project mb-30">
                                            <div class="project-img">
                                                <img src="{{ asset('landing/img/gallery/project5.png') }}" alt="">
                                            </div>
                                            <div class="project-cap">
                                                <a href="#" class="plus-btn"><i class="ti-plus"></i></a>
                                                <h4><a href="#">Floride Chemicals</a></h4>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="single-project mb-30">
                                            <div class="project-img">
                                                <img src="{{ asset('landing/img/gallery/project6.png') }}" alt="">
                                            </div>
                                            <div class="project-cap">
                                                <a href="#" class="plus-btn"><i class="ti-plus"></i></a>
                                                <h4><a href="#">Floride Chemicals</a></h4>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                    <div class="single-team mb-30">
                        <div class="team-img">
                            <img src="{{ asset('landing/img/team/team1.png') }}" alt="">
                        </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                    <div class="single-team mb-30">
                        <div class="team-img">
                            <img src="{{ asset('landing/img/team/team2.png') }}" alt="">
                        </div>
                        <div class="team-caption">
                            <span>UX Designer</span>
                            <h3>Ethan Welch</h3>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                    <div class="single-team mb-30">
                        <div class="team-img">
                            <img src="{{ asset('landing/img/team/team3.png') }}" alt="">
                        </div>
                        <div class="team-caption">
                            <span>UX Designer</span>
                            <h3>Ethan Welch</h3>
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-6 col-xs-12">
                    ...
                    <div class="single-news mb-30">
                        <div class="news-img">
                            <img src="{{ asset('landing/img/david/david_1.png') }}" alt="">
                        ...
                        <div class="news-caption">
                            ...
                            <h2><a href="#">Footprints in Time is perfect
                                    House in Kurashiki</a></h2>
                            <a href="#" class="d-btn">Read more »</a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6 col-xs-12">
                    ...
                    <div class="single-news mb-30">
                        <div class="news-img">
                            <img src="{{ asset('landing/img/david/david_2.png') }}" alt="">
                            <div class="news-date text-center">
                                <span>24</span>
                                <p>Now</p>
                            </div>
