...
@section('page-breadcrumb')
    <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item">
            <a href="{{ route('permit.index') }}"><i class="fa fa-archive"></i> Permisos por horas</a>
        </li>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                ...
                <div class="input-group">
                    ...
                    <input type="number" id="hour" name="hour" class="form-control" data-inputmask-alias="hh:mm" data-mask>
                </div>
            </div>
        </div>
