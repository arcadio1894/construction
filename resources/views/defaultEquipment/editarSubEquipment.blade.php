    ...
    <form id="formCreate" class="form-horizontal" data-url="{{ route('defaultEquipment.store') }}" enctype="multipart/form-data">
            ...
            <div class="col-md-12">
                <div class="card card-success" data-equip="asd">
                    ...
                    <div class="card-body">
                        ...
                        <div class="btn-group flex-wrap mb-3" role="group" id="keyword-selector">
                            @foreach($categoryMap as $key => $cfg)
                                <button type="button"
                                        class="btn btn-sm {{ $cfg['color'] }} mr-2 mb-2 btn-keyword"
                                        data-keyword="{{ $key }}">
                                    <i class="fas fa-check mr-1 d-none"></i>
                                    {{ $cfg['label'] }}
                                </button>
                            @endforeach
                        ...
                        <div class="keyword-section" data-keyword="materials">
                            {{-- TODO: tu bloque de MATERIALES --}}
                        ...
                        <div class="keyword-section d-none" data-keyword="consumibles">
                            {{-- TODO: tu bloque de CONSUMIBLES --}}
                        ...
                        <div class="keyword-section d-none" data-keyword="electrics">
                            {{-- TODO: tu bloque de ELÉCTRICOS --}}
                        ...
                        <div class="keyword-section d-none" data-keyword="servicios_varios">
                            {{-- TODO: tu bloque de SERVICIOS VARIOS --}}
                        ...
                        <div class="keyword-section d-none" data-keyword="dias_trabajo">
                            {{-- TODO: tu bloque de DÍAS DE TRABAJO --}}
                        ...
                        @can('showPrices_quote')
                        <div class="card col-md-6" hidden>
                            <div class="card-header">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <div class="form-group">
                            ...
                            <input type="hidden" data-materialId>
                        </div>
                    </div>
                </div>
                <div class="col-md-1">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <button type="button" data-saveDefaultEquipment class="btn btn-outline-success float-right">Guardar Subequipo</button>
            </div>
        </div>
        <!-- /.card-footer -->
    </form>
