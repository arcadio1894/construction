...
@section('page-breadcrumb')
    <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item">
            <a href="{{ route('subtype.index') }}"><i class="fa fa-key"></i> Subtipos</a>
        </li>
...
@section('content')
    <form id="formCreate" class="form-horizontal" data-url="{{ route('subtype.store') }}" enctype="multipart/form-data">
        ...
        <div class="form-group row">
            <div class="col-md-6">
                <label for="inputEmail3" class="col-12 col-form-label">Subtipo</label>
                <div class="col-sm-10">
            ...
            <div class="col-md-6">
                <label for="material_type_id" class="col-12 col-form-label">Seleccione Tipo</label>
                <div class="col-sm-10">
