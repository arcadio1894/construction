...
@section('page-title')
    <h5 class="card-title">Crear nueva entrada por Inventario</h5>
@endsection
...
<form id="formCreate" class="form-horizontal" data-url="{{ route('entry.inventory.store') }}" enctype="multipart/form-data">
    @csrf
    <div class="row">
        <div class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="number" id="price" class="form-control" placeholder="0.00" min="0"  step="0.01" pattern="^\d+(?:\.\d{1,2})?$" onblur="
                                this.style.borderColor=/^\d+(?:\.\d{1,2})?$/.test(this.value)?'':'red'
                                " value="0.00" readonly hidden>
                            </div>
                        </div>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <button type="submit" id="btn-submit" class="btn btn-outline-success float-right">Guardar ingreso por Inventario</button>
        </div>
    </div>
    <!-- /.card-footer -->
</form>
...
@section('scripts')
    ...
    <script src="{{ asset('js/entry/entry_inventory.js') }}"></script>
