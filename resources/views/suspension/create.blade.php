...
@section('activeCreateSuspension')
    active
@endsection
...
@section('page-title')
    ...
    <a href="{{ route('suspension.index') }}" class="btn btn-outline-primary btn-sm float-right" > <i class="fa fa-arrow-left font-20"></i> Listado de Permisos</a>
@endsection
...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                <strong>Importante!</strong> Al crear una suspensión se modificarán las asistencias de los días colocados.
                <br>
    ...
    <form id="formCreate" class="form-horizontal" data-url="{{ route('suspension.store') }}" enctype="multipart/form-data">
        @csrf
...
@section('scripts')
    ...
    <script src="{{ asset('js/suspension/create.js') }}"></script>
@endsection
