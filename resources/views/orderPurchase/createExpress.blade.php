...
@section('content')
    <form id="formCreate" class="form-horizontal" data-url="{{ route('order.purchase.store') }}" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group " id="sandbox-container">
                                    <label for="date_invoice">Fecha de Orden</label>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="btn-currency" type="checkbox" name="currency_invoice" data-bootstrap-switch data-off-color="primary" data-on-text="SOLES" data-off-text="DOLARES" data-on-color="success">
                                </div>
                            </div>
                        </div>
                        ...
                        <table class="table table-head-fixed text-nowrap">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ number_format((float)$material['quantity'], 2)  }}</td>
                                    <td>
