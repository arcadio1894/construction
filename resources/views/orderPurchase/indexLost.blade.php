...
@section('page-title')
    <h5 class="card-title">Listado de Ordenes de Compra perdidas</h5>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                <strong>Importante!</strong> Aqui se listan los códigos de órdenes de compra que por algún error del sistema no se crearon.
...
@section('scripts')
    ...
    <script src="{{ asset('js/orderPurchase/indexLost.js') }}?v={{ time() }}"></script>
@endsection