...
@section('page-header')
    <h1 class="page-title">Listado de Ordenes de compra express</h1>
@endsection

@section('page-title')
    <h5 class="card-title">Listado de Ordenes de compras express</h5>
...
@section('page-breadcrumb')
    <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item">
            <a href="{{route('order.purchase.express.indexV2')}}"><i class="fa fa-archive"></i> Ordenes de compra express</a>
        </li>
...
@section('scripts')
    ...
    <script src="{{ asset('js/orderPurchase/expressV2.js') }}?v={{ time() }}"></script>
