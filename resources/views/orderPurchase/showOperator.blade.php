...
@section('page-header')
    <h1 class="page-title">Visualizar orden de compra</h1>
@endsection
                    ...
                    <div class="card-body " id="element_loader">
                        ...
                        <div id="body-materials">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-1">
                                    <div class="form-group">
                                        <input type="number" class="form-control form-control-sm" onkeyup="calculateTotal2(this);" placeholder="0.00" min="0" data-price="{{$detail->id}}" value="{{ $detail->price }}" step="0.01" pattern="^\d+(?:\.\d{1,2})?$" readonly @cannot('showPrices_quote') style="display: none" @endcannot>
                                    </div>
                                </div>
                                <div class="col-md-1">
                                    <div class="form-group">
                                        <input type="number" class="form-control form-control-sm" oninput="calculateTotal3(this);" placeholder="0.00" min="0" data-price2 step="0.01" value="{{ round((float)($detail->price)/1.18, 2) }}" pattern="^\d+(?:\.\d{1,2})?$" readonly @cannot('showPrices_quote') style="display: none" @endcannot>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
...
*/
    ...
    <script src="{{ asset('js/orderPurchase/show.js') }}?v={{ time() }}"></script>
@endsection
