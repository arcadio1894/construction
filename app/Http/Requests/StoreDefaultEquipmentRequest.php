...
class StoreDefaultEquipmentRequest extends FormRequest
{
    /**
    ...
    {
        $this->merge([
            'equipments' => json_decode($this->input('equipments'), true),
        ]);
    }
    */
        ...
        public function rules()
    {
        return [
            ...
            'largeequipment' => 'required|numeric',
            'widthequipment' => 'required|numeric',
            'highequipment' => 'required|numeric', 
    ...
    public function messages()
    {
        return [
            ...
            'largeequipment.required' => 'El :attribute del equipo es requerido',
            'largeequipment.numeric' => 'El :attribute debe ser un valor numérico',
            'widthequipment.required' => 'El :attribute del equipo es requerido',
            'widthequipment.numeric' => 'El :attribute debe ser un valor numérico',
            'highequipment.required' => 'El :attribute del equipo es requerido',
