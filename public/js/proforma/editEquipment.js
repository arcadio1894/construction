...
function fillEquipment() {
    ...
    var quantity = $("#quantityequipment").val();

    //TODO: Otra vez guardamos el equipo
    var utility =   $("#utilityEquipment").val();
    var rent =      $("#rentEquipment").val();
    var letter =    $("#letterEquipment").val();

    var description = $("#descriptionequipment").val();
    var detail = $("#detailequipment").val();
