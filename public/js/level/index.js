    ...
    $('#dynamic-table').DataTable( {
            ...
            "aoColumns": [
                ...
                { data: null,
                    ...
                    {
                        return '<a href="'+document.location.origin+ '/dashboard/ver/contenedores/nivel/'+item.id+'/anaquel/'+id_shelf+'/almacen/'+id_warehouse+'/area/'+id_area+'" class="btn btn-outline-primary btn-sm"><i class="fa fa-eye"></i> Ver contenedores</a>'+
