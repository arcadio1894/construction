$(document).ready(function () {
    ...
    $('#dynamic-table').DataTable( {
        ...
        "aoColumns": [
            ...
            { data: null,
                ...
                "render": function (item)
                {
                    return '<p> '+ moment(item.date_end).format('DD/MM/YYYY') +'</p>'
                }
            },
            { data: null,
                title: 'Archivo',
                ...
                "render": function (item)
                {
                    ...
                    if ( $.inArray('delete_unpaidLicense', $permissions) !== -1 ) {
                        text = text + ' <button data-delete="'+item.id+'" data-end="'+moment(item.date_end).format('DD/MM/YYYY')+'" data-start="'+moment(item.date_start).format('DD/MM/YYYY')+'" '+
                            ' class="btn btn-outline-danger btn-sm" data-toggle="tooltip" data-placement="top" title="Eliminar licencia sin gozo"><i class="fa fa-trash"></i></button>';
                    }
                    return text;
    ...
    $('#btn-submit').on('click', destroyUnpaidLicense);
