    ...
    $('#dynamic-table').DataTable( {
            ...
            "aoColumns": [
                ...
                { data: null,
                    ...
                    {
                        return '<a href="'+document.location.origin+ '/dashboard/ver/niveles/anaquel/'+item.id+'/almacen/'+id_warehouse+'/area/'+id_area+'" class="btn btn-outline-primary btn-sm"><i class="fa fa-eye"></i> Ver niveles</a>'+
                            ' <button data-warehouse="'+item.warehouse.id+'" data-comment="'+item.comment+'" data-name="'+item.name+'" data-edit="'+item.id+'" class="btn btn-outline-warning btn-sm"><i class="fa fa-pen"></i> Editar</button>'+
