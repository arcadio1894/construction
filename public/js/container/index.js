    ...
    $('#dynamic-table').DataTable( {
        ...
        "aoColumns": [
            ...
            { data: null,
                ...
                {
                    var text = '' + '<a href="'+document.location.origin+ '/dashboard/ver/posiciones/contenedor/'+item.id+'/nivel/'+id_level+'/anaquel/'+id_shelf+'/almacen/'+id_warehouse+'/area/'+id_area+'" class="btn btn-outline-primary btn-sm"><i class="fa fa-eye"></i> Ver posiciones</a>';
                    if ( $.inArray('update_container', $permissions) !== -1 ) {
                    ...
                    if ( $.inArray('destroy_container', $permissions) !== -1 ) {
