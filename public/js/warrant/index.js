	    ...
	    $('#dynamic-table').DataTable( {
            ...
            "aoColumns": [
                ...
                { data: null,
                    ...
                    {
                        return '<a href="'+document.location.origin+ '/dashboard/editar/cedula/'+item.id+
...
function openModalDelete() {
    var warrant_id = $(this).data('delete');
    var name = $(this).data('name');

    $modalDelete.find('[id=warrant_id]').val(warrant_id);
