$(document).ready(function () {
	    $('#dynamic-table').DataTable( {
            ajax: {
                url: "/dashboard/all/materialtypes",
                dataSrc: 'data'
            },
            bAutoWidth: false,
            "aoColumns": [
...
function openModalDelete() {
    var materialtype_id = $(this).data('delete');
    var name = $(this).data('name');

    $modalDelete.find('[id=materialtype_id]').val(materialtype_id);
    $modalDelete.find('[id=name]').html(name);

    $modalDelete.modal('show');
}

function destroymaterialtype() {
