	    ...
	    $('#dynamic-table').DataTable( {
            ...
            "aoColumns": [
                ...
                { data: null,
                    ...
                    {
                        return '<a href="'+document.location.origin+ '/dashboard/editar/subtipo/'+item.id+
...
function openModalDelete() {
    var subtype_id = $(this).data('delete');
    var name = $(this).data('name');

    $modalDelete.find('[id=subtype_id]').val(subtype_id);
    $modalDelete.find('[id=name]').html(name);

    $modalDelete.modal('show');
}

function destroySubtype() {
