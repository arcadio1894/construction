            ...
            "aoColumns": [
                ...
                { data: null,
                    ...
                    "render": function (item)
                    {
                        ...
                        return  '<a href="'+document.location.origin+ '/dashboard/editar/retaceria/'+item.id+
...
function openModalDelete() {
    var brand_id = $(this).data('delete');
    var name = $(this).data('name');

    $modalDelete.find('[id=brand_id]').val(brand_id);
    $modalDelete.find('[id=name]').html(name);

    $modalDelete.modal('show');
}

function destroyTypescrap() {
