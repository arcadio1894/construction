$(document).ready(function () {
    ...
    $('#btn-submit').on('click', storeSuspension);
...
function storeSuspension() {
    ...
    if ( $('#reason_id').val() == '' )
    {
        toastr.error('Seleccione una razón suspensión', 'Error',
            {
                "closeButton": true,
                "debug": false,
                "newestOnTop": false,
    ...
    if (totalDays <= 0)
    {
        toastr.error('Las fechas están en desorden.', 'Error',
            {
                "closeButton": true,
                "debug": false,
                "newestOnTop": false,
